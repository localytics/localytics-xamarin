...
namespace LocalyticsXamarin.iOS
{
	...
	interface Localytics
	{
		...
		void IncrementProfileAttribute (int value, string attribute, LLProfileScope scope);
		...
		void DecrementProfileAttribute (int value, string attribute, LLProfileScope scope);
