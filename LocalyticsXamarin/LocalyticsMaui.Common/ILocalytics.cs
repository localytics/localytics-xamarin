...
namespace LocalyticsMaui.Common
{
    ...
    {
        /// <summary>
        /// Gets a value indicating whether this <see cref="T:LocalyticsMaui.Common.IInAppCampaign"/> is responsive.
        /// </summary>
    ...
    public interface ILocalytics
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="T:LocalyticsMaui.Common.ILocalytics"/> privacy
        /// opted out.
        /// </summary>
